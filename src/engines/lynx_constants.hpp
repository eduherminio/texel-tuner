...
constexpr static std::array<u64, 64> WhitePassedPawnMasksBySide = {
    0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL,
    2UL, 5UL, 10UL, 20UL, 40UL, 80UL, 160UL, 64UL,
    514UL, 1285UL, 2570UL, 5140UL, 10280UL, 20560UL, 41120UL, 16448UL,
    131586UL, 328965UL, 657930UL, 1315860UL, 2631720UL, 5263440UL, 10526880UL, 4210752UL,
    33686018UL, 84215045UL, 168430090UL, 336860180UL, 673720360UL, 1347440720UL, 2694881440UL, 1077952576UL,
    8623620610UL, 21559051525UL, 43118103050UL, 86236206100UL, 172472412200UL, 344944824400UL, 689889648800UL, 275955859520UL,
    2207646876162UL, 5519117190405UL, 11038234380810UL, 22076468761620UL, 44152937523240UL, 88305875046480UL, 176611750092960UL, 70644700037184UL,
    565157600297474UL, 1412894000743685UL, 2825788001487370UL, 5651576002974740UL, 11303152005949480UL, 22606304011898960UL, 45212608023797920UL, 18085043209519168UL};

constexpr static std::array<u64, 64> BlackPassedPawnMasksBySide = {
    144680345676153344UL, 361700864190383360UL, 723401728380766720UL, 1446803456761533440UL, 2893606913523066880UL, 5787213827046133760UL, 11574427654092267520UL, 4629771061636907008UL,
    144680345676152832UL, 361700864190382080UL, 723401728380764160UL, 1446803456761528320UL, 2893606913523056640UL, 5787213827046113280UL, 11574427654092226560UL, 4629771061636890624UL,
    144680345676021760UL, 361700864190054400UL, 723401728380108800UL, 1446803456760217600UL, 2893606913520435200UL, 5787213827040870400UL, 11574427654081740800UL, 4629771061632696320UL,
    144680345642467328UL, 361700864106168320UL, 723401728212336640UL, 1446803456424673280UL, 2893606912849346560UL, 5787213825698693120UL, 11574427651397386240UL, 4629771060558954496UL,
    144680337052532736UL, 361700842631331840UL, 723401685262663680UL, 1446803370525327360UL, 2893606741050654720UL, 5787213482101309440UL, 11574426964202618880UL, 4629770785681047552UL,
    144678138029277184UL, 361695345073192960UL, 723390690146385920UL, 1446781380292771840UL, 2893562760585543680UL, 5787125521171087360UL, 11574251042342174720UL, 4629700416936869888UL,
    144115188075855872UL, 360287970189639680UL, 720575940379279360UL, 1441151880758558720UL, 2882303761517117440UL, 5764607523034234880UL, 11529215046068469760UL, 4611686018427387904UL,
    0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL};

constexpr static std::array<std::array<u64, 64>, 2> SidePassedPawnMasksBySide = {{

    {WhitePassedPawnMasksBySide}, //
    {BlackPassedPawnMasksBySide}}};

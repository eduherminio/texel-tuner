...
constexpr std::array<int, 12> PieceValue = {
    +94, +348, +362, +493, +1090,  // 0
    +122, +420, +356, +736, +1404, // 0
};

constexpr static std::array<int, 64> MiddleGamePawnTable = {
    0, 0, 0, 0, 0, 0, 0, 0,
    -21, -22, -14, -12, -7, 20, 23, -10,
    -24, -27, -8, 8, 15, 24, 20, 9,
    -20, -14, 4, 17, 26, 31, 6, -0,
    -20, -9, 3, 20, 28, 29, 5, -0,
    -23, -20, -7, 0, 8, 21, 13, 2,
    -22, -19, -20, -15, -8, 15, 12, -19,
    0, 0, 0, 0, 0, 0, 0, 0};
...
constexpr static std::array<int, 64> EndGamePawnTable = {
    ...
    15, 11, 5, -5, 8, 3, -5, -4,
    10, 6, -2, -15, -9, -9, -11, -10,
    26, 16, -1, -20, -15, -14, 4, 1,
    24, 15, -2, -16, -14, -12, 2, -1,
    12, 4, -5, -13, -6, -8, -10, -10,
    18, 11, 10, -5, 17, 7, -2, 0,
    0, 0, 0, 0, 0, 0, 0, 0};

constexpr static std::array<int, 64> MiddleGameKnightTable = {
    -140, -19, -46, -30, -9, -14, -7, -73,
    -42, -30, -6, 15, 18, 25, -7, -2,
    -33, -2, 12, 49, 50, 33, 25, -7,
    -13, 21, 35, 51, 50, 51, 43, 14,
    -8, 20, 38, 38, 48, 49, 43, 12,
    -33, -3, 12, 43, 46, 25, 19, -8,
    -44, -17, -1, 14, 15, 21, -7, -1,
    -158, -23, -46, -17, -7, -5, -16, -64};

constexpr static std::array<int, 64> EndGameKnightTable = {
    -52, -36, -6, 0, -5, -26, -30, -78,
    -6, 7, 8, 3, 3, -2, -10, -14,
    -9, 6, 24, 26, 22, 6, -1, -8,
    11, 12, 37, 37, 42, 34, 15, -2,
    6, 15, 36, 41, 43, 33, 19, 6,
    -11, 9, 15, 30, 22, 6, -3, -5,
    -13, 7, -1, 5, -1, -8, -7, -20,
    -52, -35, 1, -6, -7, -26, -30, -76};

constexpr static std::array<int, 64> MiddleGameBishopTable = {
    -11, 10, -9, -20, -18, -9, -21, 11,
    3, 1, 3, -18, 1, 1, 34, -6,
    -8, 0, -9, 4, -12, 6, -2, 24,
    -5, -7, -2, 23, 22, -13, 2, -3,
    -15, -2, -10, 21, 9, -8, -6, 6,
...
constexpr static std::array<int, 64> MiddleGameRookTable = {
    -5, -10, -7, -1, 8, 6, 12, 2,
    -30, -17, -11, -8, 3, 9, 27, -1,
    -33, -20, -22, -9, 2, 8, 43, 25,
    -30, -25, -22, -8, -5, 7, 36, 15,
    -22, -18, -14, -6, -6, 6, 34, 10,
    -22, -14, -15, -1, 4, 20, 47, 20,
    -26, -25, -7, -1, 4, 9, 30, 4,
    -3, -3, -2, 9, 15, 10, 18, 10};
...
constexpr static std::array<int, 64> EndGameRookTable = {
    6, 4, 8, 0, -7, -1, -5, -7,
    19, 18, 18, 8, -2, -5, -9, -0,
    16, 10, 12, 2, -8, -11, -21, -17,
    16, 12, 13, 4, -3, -3, -16, -14,
    15, 10, 11, 2, -2, -7, -16, -9,
    14, 12, 3, -4, -12, -15, -23, -9,
    19, 21, 14, 3, -3, -6, -9, 1,
    2, -2, 4, -5, -15, -9, -9, -14};
...
constexpr static std::array<int, 64> MiddleGameQueenTable = {
    -13, -11, -12, 4, -2, -31, -1, 1,
    -4, -10, 7, -1, 2, 12, 25, 50,
    -12, -9, -10, -10, -14, 4, 28, 48,
    -12, -17, -17, -8, -6, -3, 13, 23,
    -9, -13, -15, -14, -6, -1, 13, 21,
    -9, -6, -14, -11, -8, 2, 16, 31,
    -16, -18, 4, 12, 8, 8, 12, 39,
    -8, -10, -1, 7, 2, -34, -18, 26};

constexpr static std::array<int, 64> EndGameQueenTable = {
    -20, -17, -3, -11, -16, -17, -23, 14,
    -11, -5, -23, -4, -3, -25, -48, -7,
    -9, -1, 5, 3, 20, 21, -4, 10,
    -8, 6, 8, 10, 22, 33, 39, 32,
    -4, 0, 10, 20, 19, 26, 19, 41,
    -11, -9, 11, 8, 12, 15, 16, 19,
    -5, -4, -21, -23, -16, -21, -35, -1,
    -15, -12, -11, -8, -11, 4, 17, 1};

constexpr static std::array<int, 64> MiddleGameKingTable = {
    3, 32, 27, -67, 11, -62, 27, 14,
    -18, -16, -25, -61, -73, -50, -11, -2,
    -76, -62, -99, -100, -109, -113, -81, -97,
    -96, -65, -99, -142, -139, -116, -118, -148,
    -60, -47, -89, -120, -137, -106, -116, -142,
    -60, -46, -81, -84, -77, -92, -66, -79,
    59, -5, -19, -41, -47, -30, 12, 11,
    15, 56, 43, -48, 33, -44, 46, 33};

constexpr static std::array<int, 64> EndGameKingTable = {
    -74, -46, -26, -1, -40, -8, -40, -87,
    -20, 16, 24, 36, 43, 30, 9, -28,
    -2, 39, 68, 80, 82, 72, 39, 10,
    1, 49, 88, 119, 118, 89, 61, 24,
    -9, 42, 86, 116, 120, 89, 62, 21,
    -4, 36, 67, 78, 75, 66, 36, 2,
    -47, 10, 25, 35, 36, 25, 2, -33,
    -86, -55, -33, -8, -39, -13, -46, -93};

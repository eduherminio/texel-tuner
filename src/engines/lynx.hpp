...
int AdditionalPieceEvaluation(int pieceSquareIndex, int pieceIndex, int bucket, const u64 opponentPawnAttacks, const chess::Board &board, const chess::Color &color, coefficients_t &coefficients)
{
    switch (pieceIndex)
    {
    case 0:
...
EvalResult Lynx::get_external_eval_result(const chess::Board &board)
{
    ...
    for (int pieceIndex = 0; pieceIndex < 5; ++pieceIndex)
    {
        ...
        while (bitboard != 0)
        {
            ...
            packedScore += AdditionalPieceEvaluation(pieceSquareIndex, pieceIndex, whiteBucket, blackPawnAttacks, board, chess::Color::WHITE, coefficients);
    ...
    for (int pieceIndex = 6; pieceIndex < 11; ++pieceIndex)
    {
        ...
        while (bitboard != 0)
        {
            ...
            packedScore -= AdditionalPieceEvaluation(pieceSquareIndex, pieceIndex, blackBucket, whitePawnAttacks, board, chess::Color::BLACK, coefficients);
